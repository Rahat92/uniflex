...
import * as asset_model from './account_report_approval_doc_model';
...
interface models {
    AccountReportApprovalDocModel: typeof asset_model.DataModel;
    // Project: typeof asset_model.DataModel;
    sequelize: Sequelize;
}
const db = async function (): Promise<models> {
    const AccountReportApprovalDocModel = asset_model.init(sequelize);
    ...
    //     sourceKey: 'id',
    //     foreignKey: 'number',
    //     as: 'account-report-approval-docs',
    // });
