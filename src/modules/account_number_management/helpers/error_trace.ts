async function error_trace(
    ...
    try {
        await models.sequelize.query(
            `INSERT INTO error_traces (account_id, details, uid, url, params) VALUES (${JSON.stringify(error.message)}, '${JSON.stringify(error.stack)}', '${uid}', '${url}', '${JSON.stringify(params)}')`,
        );
    } catch (error) {
