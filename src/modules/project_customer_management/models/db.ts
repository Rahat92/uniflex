...
import * as asset_model from './project_customer_model';
...
interface models {
    ProjectCustomerModel: typeof asset_model.DataModel;
    // Project: typeof asset_model.DataModel;
    sequelize: Sequelize;
}
const db = async function (): Promise<models> {
    const ProjectCustomerModel = asset_model.init(sequelize);
