...
import * as asset_model from './account_category_model';
...
interface models {
    AccountCategoryModel: typeof asset_model.DataModel;
    // Project: typeof asset_model.DataModel;
    sequelize: Sequelize;
}
const db = async function (): Promise<models> {
    const AccountCategoryModel = asset_model.init(sequelize);
