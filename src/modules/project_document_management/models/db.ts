...
import * as asset_model from './project_document_model';
...
interface models {
    ProjectDocumentModel: typeof asset_model.DataModel;
    // Project: typeof asset_model.DataModel;
    sequelize: Sequelize;
}
const db = async function (): Promise<models> {
    const ProjectDocumentModel = asset_model.init(sequelize);
