...
import * as asset_model from './project_responsibility_model';
...
interface models {
    ProjectResponsibilityModel: typeof asset_model.DataModel;
    // Project: typeof asset_model.DataModel;
    sequelize: Sequelize;
}
const db = async function (): Promise<models> {
    const ProjectResponsibilityModel = asset_model.init(sequelize);
