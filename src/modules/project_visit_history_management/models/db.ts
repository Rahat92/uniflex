...
import * as asset_model from './project_visit_history_model';
...
interface models {
    ProjectVisitHistoryModel: typeof asset_model.DataModel;
    // Project: typeof asset_model.DataModel;
    sequelize: Sequelize;
}
const db = async function (): Promise<models> {
    const ProjectVisitHistoryModel = asset_model.init(sequelize);
