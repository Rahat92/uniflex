...
import profileSetup from './config/setup';
...
const Edit: React.FC<Props> = (props: Props) => {
    ...
    console.log('password', get_value('password'))
    return (
        <>
            <div className="page_content">
                <div className="explore_window fixed_size">
                    <Header page_title={profileSetup.edit_page_title}></Header>
