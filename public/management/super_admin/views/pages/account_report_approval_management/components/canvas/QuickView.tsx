                        ...
                        <table className="table quick_modal_table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>:</th>
                                    <th>{state.item.openning_balance}</th>
                                </tr>
                                <tr>
                                    <th>Closing Balance</th>
                                    <th>:</th>
                                    <th>{state.item.closing_balance}</th>
                                </tr>
                                <tr>
                                    <th>Is Approved</th>
                                    <th>:</th>
                                    <th>{state.item.is_approved}</th>
                                </tr>
                                <tr>
                                    <th>Approved By</th>
                                    <th>:</th>
                                    <th>{state.item.approved_by}</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>Not Approved Comment</th>
                                    <th>:</th>
                                    <th>{state.item.not_approved_comment}</th>
                                </tr>
                                <tr>
                                    <th>Status</th>
                                    <th>:</th>
